...
export default function Footer() {
    return (
        <footer className="w-full mt-8 bg-gray-900 dark:bg-gray-950 text-gray-300 dark:text-gray-400">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 grid md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul className="mt-2 space-y-2 text-sm">
                        <li>
                            <Link href="/support" className="hover:text-pharmacy-400 dark:hover:text-pharmacy-300 transition-colors">Suporte</Link>
                        </li>
                        <li>
                            <Link href="/about" className="hover:text-pharmacy-400 dark:hover:text-pharmacy-300 transition-colors">Quem Somos</Link>
                        </li>
                        <li>
                            <Link href="/auth/login" className="hover:text-pharmacy-400 dark:hover:text-pharmacy-300 transition-colors">Entrar</Link>
                        </li>
                    </ul>
                </div>
            </div>
