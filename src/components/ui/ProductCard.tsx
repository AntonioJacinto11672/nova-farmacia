...
export default function ProductCard({ id, name, price, image, isActive, description, medicineCategories }: Props) {
    ...
    return (
        <div className="group rounded-xl bg-white  dark:bg-slate-800 flex flex-col transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
            ...
            <div className="p-5 flex flex-col flex-1">
                <div className="mb-4">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-300 line-clamp-2"> {description && "Descrição breve do produto em destaque com detalhes importantes."} </p>
                </div>
                ...
                <div className="mt-auto">
                    ...
                    <div className="flex gap-2 sm:flex-row flex-col">
                        <button className="flex-1 flex items-center justify-center gap-2 rounded-lg bg-white  dark:bg-slate-800 border-2 border-blue-600 px-4 py-2 text-blue-600 font-medium hover:bg-blue-50 transition-colors group" onClick={() => {router.push(`/products/${id}`)}}>
