...
export default function ProvidersPage() {
  ...
  async function submitCreateOrEdit(data: ProviderFormValues) {
    // data validated by zod
    setLoading(true)
    try {
      const svc = new ProviderService()
      // API expects a name at least; extend payload as needed by backend
      await svc.createProvider(data.name)
